...
// Class constructor
public class OrbitSimulationToone extends JFrame {
    ...
    public OrbitSimulationToone() {
        ...
        // Add them to control panel in order
        controlPanel.add(playButton);
        controlPanel.add(pauseButton);
        controlPanel.add(stepButton);
        controlPanel.add(dayLabel);

        // Actually add the previous elements to the GUI
    ...
    // Add funcitonality for start, stop, and step
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new OrbitSimulationToone().setVisible(true));
    }
    ...
    class DrawingPanel extends JPanel {
        ...
        // Create instances of celestial bodies and their orbits
    ...
    // Define CelestialBody class so Sun, Moon, and Earth can inherit its attributes
    class CelestialBody {
        String name;
        int size;
        Color color;
